...
.video-js .vjs-title-bar{display:none;width:100%;position:absolute;top:0;left:0;height:7.2em;text-align:left;padding:16px 21px;pointer-events:none}.video-js .vjs-title-bar .vjs-title-bar-title{width:100%;font-size:1.2em;font-weight:500;line-height:1.2em;margin-bottom:.55em}.video-js .vjs-title-bar .vjs-title-bar-subtitle{width:100%;font-size:1em;font-weight:300;line-height:1em}.vjs-has-started .vjs-title-bar{display:flex;flex-direction:column;align-items:center;visibility:visible;opacity:1;transition:visibility .1s,opacity .1s}.vjs-has-started.vjs-user-inactive.vjs-playing .vjs-title-bar{visibility:visible;opacity:0;transition:visibility 1s,opacity 1s}.vjs-controls-disabled .vjs-title-bar,.vjs-using-native-controls .vjs-title-bar,.vjs-error .vjs-title-bar,.vjs-ad-playing .vjs-title-bar{display:none !important}.vjs-audio.vjs-has-started.vjs-user-inactive.vjs-playing .vjs-title-bar{opacity:1;visibility:visible}.vjs-has-started.vjs-no-flex .vjs-title-bar{display:table}
.video-js .vjs-volume-panel-horizontal .vjs-volume-level:before,.video-js .vjs-volume-panel-horizontal .vjs-volume-control:before{content:"";font-size:20px;position:absolute;top:0;left:0;width:0;height:0;line-height:0px;border-style:solid;border-width:0 0 1.2em 6em;border-color:rgba(0,0,0,0) rgba(0,0,0,0) #0e2f5a rgba(0,0,0,0)}.video-js .vjs-volume-panel-horizontal .vjs-volume-control{overflow:hidden;height:3em}.video-js .vjs-volume-panel-horizontal .vjs-volume-bar{margin:0;height:100%;background-color:rgba(0,0,0,0)}.video-js .vjs-volume-panel-horizontal .vjs-volume-level{overflow:hidden;height:100%;background:rgba(0,0,0,0);box-shadow:none}.video-js .vjs-volume-panel-horizontal .vjs-volume-level:before{border-color:rgba(0,0,0,0) rgba(0,0,0,0) #e8e8e9 rgba(0,0,0,0)}
...
.vjs-vtt-thumbnail-display{position:absolute;left:0;bottom:15px;z-index:1;opacity:0;transition:opacity .2s;bottom:3em;pointer-events:none;border:3px solid #fff;border-radius:3px;box-shadow:0 0 3px rgba(0,0,0,.3);backdrop-filter:blur(12px)}.vjs-vtt-time-display{position:absolute;bottom:-1.7em;left:0;right:0;margin:auto;color:#fff;text-shadow:0 0 3px #000}.vjs-vtt-thumbnails .vjs-time-tooltip{display:none !important}
.vjs-progress-control::before{content:"";pointer-events:none;position:absolute;bottom:50%;left:0;right:0;width:100%;height:600%;background:linear-gradient(to bottom, transparent 0%, currentColor 100%);opacity:.4;z-index:0}.vjs-highlights-graph-display{position:absolute;left:0;right:0;bottom:50%;z-index:0;pointer-events:none;opacity:0;transition:opacity .2s}.vjs-progress-control:hover .vjs-highlights-graph-display{opacity:.8}.vjs-highlights-graph-display svg{width:100%;height:100%}.vjs-highlights-graph-display path{fill:currentColor}
