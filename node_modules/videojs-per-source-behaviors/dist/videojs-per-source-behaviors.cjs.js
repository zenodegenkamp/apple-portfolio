...
const perSourceBehaviors = function () {
  ...
  const createPerSrcBinder = isOne => {
    return function (first, second) {
      ...
      const originalListener = videojs__default["default"].bind(isTargetPlayer ? this : first, arguments[arguments.length - 1]); // The wrapped listener `subargs` are the arguments passed to the original
  ...
  this.perSourceBehaviors = {
     ...
     * @return {boolean}
     */
    disable: videojs__default["default"].bind(this, function disable() {
